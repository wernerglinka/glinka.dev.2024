...
item: "build-badges-section" # used as a key for bloglist filters
...
image:
  ...
  alt: ""
  caption:
excerpt: "Learn how to implement a versatile badge section for your website using Metalsmith and Nunjucks templating. This guide details how to list features, awards or customers, controlling what to display and the order, with ease and flexibility."
        ...
        blocks:
          - name: text
            ...
            prose: |-
              ...
              ![](https://res.cloudinary.com/glinkaco/image/upload/v1650491861/tgc2022/blogImages/build-badges-section/badges-header_nrd7sx.png)
